          ...
          <div class="uk-width-1-1 uk-row-first">
            <div class="uk-panel">
              <div class="footer-logo">
                <a href="/"
                  ><img src="@/assets/footer-logo-img.png" alt="" /><span
                    >Sport</span
                  >.ak</a
                >
              </div>
      ...
      <div class="uk-container uk-container-center">
        ...
        >
          <div class="uk-width-1-1 uk-width-large-1-2 uk-row-first">
            <div class="uk-panel" style="min-height: 94px">
                ...
                >
                  ...
                  <ul class="uk-slideshow" style="height: 37px">
                    <li
                      class=""
                      aria-hidden="true"
                      style="height: 37px; animation-duration: 500ms"
                    >
          ...
          <div class="uk-width-1-1 uk-width-large-1-2">
            <div class="uk-panel" style="min-height: 94px">
              ...
              >
                ...
                >
                  <form
                    id="formAcymailing54111"
                    method="post"
                    name="formAcymailing54111"
                  >
                    <div class="acymailing_module_form">
                      <div class="mail-title">Newsletters</div>
                      <div class="acymailing_introtext">
                        Suspendisse sodales, magna at dignissim cursus, velit ex
                        porttitor eros.
                      </div>
                      <div class="clear"></div>
                      <div class="space"></div>
              ...
              <div class="footer-wrap">
                <div class="foot-menu-wrap">
                  <ul class="nav menu">
                    ...
                    <li class="item-169"><a href="news.html">News</a></li>
                  </ul>
                </div>
                <div class="copyrights">
                  Copyright © 2015 <a href="/">Sportak Team</a>. All Rights
                  Reserved.
                </div>
                <div class="clear"></div>
              </div>
